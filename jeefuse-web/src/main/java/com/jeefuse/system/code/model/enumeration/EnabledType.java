...
public enum EnabledType {
	...
	/** @generated */
	private EnabledType(String key, String label) {
		this.key = key;
		this.label = label;
	}
	 ...
	 * @generated
	 */
	public static EnabledType valueOfKey(String key) {
		if (null == key)
			return INVALID;
		for (EnabledType item : values()) {
	 ...
	 * @generated
	 */
	static public EnabledType valueOfLabel(String label) {
		if (null == label)
			return INVALID;
		for (EnabledType item : values()) {
	...
	/** @generated */
	static public String renderStyle(EnabledType item) {
		return getRenderFont(item).renderStyle();
	}

	/** @generated */
	static private HtmlFont getRenderFont(EnabledType item) {
		switch (item) {
		case VALID:
