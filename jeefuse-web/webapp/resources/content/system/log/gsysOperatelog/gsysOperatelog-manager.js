...
$(function(){
    ...
    var option = {
        height: h, 
        width: w,
        url: ctx+'/system/log/gsysOperatelog/listOutJson.vhtml',
        colModel: [
		   { display: '登录IP',name: 'loginIp',width: 116, sortable: true, align: 'left'}
		   ,{ display: '创建时间',name: 'createdate',width: 60, sortable: true, align: 'left'}
		   ,{ display: '信息',name: 'message',width: 257, sortable: false, align: 'left'}
		   ,{ display: '操作用户',name: 'gsysUser.username',width: 116, sortable: true, align: 'left'}
		   ,{ display: '类型',name: 'kind',width: 60, sortable: true, align: 'left',process:formatLogType}
		],      
		indexId:'id',
		sortname: "id",
		sortorder: "desc",
