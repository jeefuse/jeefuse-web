...
<script>
	...
	importJsFile('/resources/content/system/code/gsysCodevalue/gsysCodevalue-input.js', ctx);
</script>
</head>
 				...
 				<input type="hidden" id="id" name="id" value="${mo.id}"/>
		      	<table>
		      		<tr>
		      			...
		      			<td class="field">		      				 
		      				 <select name="gsysCode.cid" id="gsysCode_cid" class="text">
							     <option value="" >无</option>
							     <s:property value="gsysCodeKeyLabelSelect" escape="false"/>
							 </select>
		      			</td>
		      		</tr>
					<tr>
					...
					<tr>
		      		...
		      		<tr>
		      			...
		      			<td class="field" colspan="3">
		      				<input type="text" id="descript" name="descript" value="${mo.descript}" class="text" />
		      			</td>
		      		</tr>	
				</table>
			</form>
