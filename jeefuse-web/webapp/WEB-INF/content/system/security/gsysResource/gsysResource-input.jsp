...
<head>
<title>GsysResource Input</title>
...
<script>
	...
	importJsFile('/resources/content/system/security/gsysResource/gsysResource-input.js', ctx);
</script>
</head>
					...
					<tr>
						...
						<td class="field">
							<select name="type" id="type" class="text">
							     <s:property value="ResourceTypeHtmlSelect" escape="false"/>
							 </select>
						</td>						
					</tr>
		      		<tr>
		      		...
		      		<tr>
		      			...
		      			<td class="field" >
		      				<textarea name="value" rows="3" cols="60" >${mo.value}</textarea>
		      			</td>
		      		</tr>
				</table>
			</form>
