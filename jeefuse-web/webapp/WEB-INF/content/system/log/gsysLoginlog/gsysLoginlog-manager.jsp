...
<script>
	...
	importJsFile('jquery|blockUI|common|ui|flexiGrid|validate|contextmenu|datePicker', ctx);
	importJsFile('/resources/content/system/log/gsysLoginlog/gsysLoginlog-manager.js', ctx);
</script>
